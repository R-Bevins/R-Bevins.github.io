...
function changeTextButcher(){
    document.getElementById("outputD").innerHTML = "Chance Meating is the short film I completed for my sophomore year at RIT's School of Film and Animation. I quite enjoy exploring ironic comedy in my projects, which I felt I was able to do well here. It was animated entirely in Blender, and I modeled and rigged the characters on my own. It was completed on April 28th, 2025.";
        document.getElementById("outputD2").innerHTML = "";
    document.getElementById("outputD3").innerHTML = "";
    document.getElementById("outputD4").innerHTML = "";
    document.getElementById("outputD5").innerHTML = "";
        document.getElementById("outputN").innerHTML ="Chance Meating";
        document.getElementById("lbImage").title= "Chance Meating";
        document.getElementsByClassName("lb-caption").innerHTML= "Chance Meating";
        }
